...
* Definición del producto final a nivel de experiencia y de interfaz:
   ...
   [url("src/img/BosquejoEnHTMLyCSS.png")]
   ...
   [url("src/img/PrimerResultadoEncriptar.png")]
   ...
   [url("src/img/CSSyHTMLfondoYbotones.png")]
